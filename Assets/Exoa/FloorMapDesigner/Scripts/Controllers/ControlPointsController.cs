...
namespace Exoa.Designer
{
    public class ControlPointsController : MonoBehaviour
    {
        ...
        public GameEditorEvents.OnGameEditorEventBoolHandler OnRequestRemoval;
        ...
        void Start()
        {
            ...
            OnControlPointsChanged += CreatePathVisualization;
            OnRequestPathRedraw += CreatePathVisualization;
            //ControlPointInfoPopup.OnClickSplit?.AddListener(OnClickSplit);
        }

        public void DeleteSpace()
        {
            OnRequestRemoval?.Invoke(true);
        }
        ...
        {
            HDLogger.Log("ControlPoints OnRequestClearAll", HDLogger.LogCategory.Floormap);
        ...
        public void ToggleDrawMode(bool request = true)
        {
