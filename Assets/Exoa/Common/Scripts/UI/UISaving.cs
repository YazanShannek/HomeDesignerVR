...
namespace Exoa.Designer
{
    public class UISaving : GenericLeftMenu
    {
        ...
        protected void OnLevelListChanged(List<string> list, FileType fileType = FileType.FloorMapFile)
        {
            ...
            foreach (string name in list)
            {
                ...
                plmi.LoadImages(thumbnailPrefix);
        ...
        public bool SaveInternal(string name, Action<string> callback = null)
        {
            ...
            SaveSystem.Create(SaveSystem.Mode.FILE_SYSTEM).SaveFileItem(name, dataSerializer.GetFolderName(), lastSaveContent, callback == null ? OnSaveDone : callback);
        ...
        public void GetFileList(string arg = null, FileType fileType = FileType.FloorMapFile)
        {
            ...
            if (fileType == FileType.FloorMapFile || fileType == FileType.InteriorFile || fileType == FileType.ScreenshotFile)
            {
                ...
                {
                    OnLevelListChanged(l.list, fileType);
                });
            }
