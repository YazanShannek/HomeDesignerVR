...
namespace Exoa.Effects
{
    ...
    public class OutlineSetup : UnityEditor.EditorWindow
    {
        ...
        [MenuItem("Tools/Exoa/Outline Setup")]
        ...
        private static void ShowWindow()
        {
            ...
            var window = EditorWindow.GetWindow<OutlineSetup>(true, "EPO Setuper", false);
