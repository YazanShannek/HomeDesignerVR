...
{
    /// <summary>
    /// HomeReader is responsible for reading and managing floor maps and interior designs.
    /// It interacts with floor maps and interior project files and provides functionality
    /// to preview and load layouts within a Unity scene.
    /// </summary>
    public class HomeReader : BaseReader, IDataReader
    {
        ...
        /// <summary>
        /// Event triggered when the object is destroyed. Unsubscribes from editor events.
        /// </summary>
        void OnDestroy()
        {
        ...
        /// <summary>
        /// Initializes the HomeReader and subscribes to necessary events.
        /// </summary>
        void Awake()
        {
            GameEditorEvents.OnRequestClearAll += OnRequestClearAll;
        ...
        /// <summary>
        /// Handles floor action requests, specifically for previewing buildings.
        /// </summary>
        /// <param name="action">The type of action being requested.</param>
        /// <param name="fileName">The name of the floor map file.</param>
        ...
        /// <summary>
        /// Clears all floors and other elements based on the provided flags.
        /// </summary>
        /// <param name="clearFloorsUI">Indicates whether to clear the floor UI.</param>
        ...
        /// <summary>
        /// Clears the current loaded floors and resets the state.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// Gets the folder name where interior files are stored.
        /// </summary>
        ...
        /// <summary>
        /// Replaces and loads a specified floor map by name.
        /// </summary>
        /// <param name="name">The name of the floor map file to load.</param>
        /// <param name="sendLoadedEvent">Flag to indicate if a loaded event should be sent.</param>
        ...
        /// <summary>
        /// Loads a floor map from a file and handles related processes.
        /// </summary>
        /// <param name="name">The name of the floor map file to load.</param>
        /// <param name="sendLoadedEvent">Indicates whether to send a loaded event or not.</param>
        ...
        /// <summary>
        /// Deserializes a JSON string to create interior objects in the scene.
        /// </summary>
        /// <param name="str">The JSON string containing interior data.</param>
        /// <returns>The current interior file object after deserialization.</returns>
        ...
        /// <summary>
        /// Deserializes the floor map and interior file into the scene, creating floor and room objects.
        /// </summary>
        /// <param name="currentInteriorFile">The current interior project file.</param>
        /// <param name="currentFloorMapFile">The current floor map file.</param>
        ...
        /// <summary>
        /// Deserializes the interior data for a specific level and associates it with the corresponding floor controller.
        /// </summary>
        /// <param name="level">The interior level data to deserialize.</param>
        /// <param name="fc">The FloorController managing this interior level.</param>
        ...
        /// <summary>
        /// Unloads the current interior designer and any related components cleanly.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the InteriorDesigner component, creating it if it does not exist.
        /// </summary>
        /// <returns>The InteriorDesigner component.</returns>
        ...
        /// <summary>
        /// Retrieves the FloorMapReader component, creating it if it does not exist.
        /// </summary>
        /// <returns>The FloorMapReader component.</returns>
